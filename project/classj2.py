"""
Changing the createNewPopulationWithElitism method to add migrants : new set of random generated individuals
"""
...
class Population:
    ...
    def createNewPopulationWithElitism(self, newIndividuals):
        pourcentageOfNewIndividuals = 0.6
        pourcentageOfMigrants = 0.2
        numberOfNewIndividuals = round(pourcentageOfNewIndividuals * self.nbOfIndividuals)
        numberOfMigrants = round(pourcentageOfMigrants * self.nbOfIndividuals)
        numberOfOldIndividuals = self.nbOfIndividuals - numberOfNewIndividuals - numberOfMigrants
        newIndividuals = self.sortIndividualsByFitness(newIndividuals)[:numberOfNewIndividuals]
        migrants = self.generateSpecificNumberOfIndividuals(numberOfMigrants)
        oldIndividuals = self.individuals[:numberOfOldIndividuals] # The individuals here will already be sorted
        self.individuals = self.sortIndividualsByFitness(oldIndividuals + newIndividuals + migrants)
