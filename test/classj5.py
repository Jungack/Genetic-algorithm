...
class Population:
    ...
    def createNewPopulationWithElitism(self, newIndividuals):
        pourcentageOfNewIndividuals = 0.8
        numberOfNewIndividuals = round(pourcentageOfNewIndividuals * self.nbOfIndividuals)
        numberOfMigrants = self.nbOfIndividuals - numberOfNewIndividuals
        ...
        self.individuals = self.sortIndividualsByFitness(newIndividuals + migrants)
    ...
    def main(self):
        ...
        actualFitnessList = [answer.fitness]
